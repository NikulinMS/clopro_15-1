# Домашнее задание к занятию "`Организация сети`" - `Никулин Михаил Сергеевич`
...
```bash
nikulinn@nikulin:~/other/clopro_15-1/scr/terraform$ terraform plan
...
```bash
nikulinn@nikulin:~/other/clopro_15-1/scr/terraform$ ssh centos@62.84.113.91
